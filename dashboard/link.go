...
func (link ExternalLink) asSdk() sdk.Link { _ = "STUB: not implemented"; return *new(sdk.Link) }
...
func (link DashboardLink) asSdk() sdk.Link { _ = "STUB: not implemented"; return *new(sdk.Link) }
